...
export default function HomePage() {
  return (
    <main className="flex lg:h-full h-screen flex-col items-center text-center bg-cover bg-center bg-no-repeat bg-[url('https://assets.uploadfast.dev/Hypercolor%20Gradient%20(2)-27oj.jpeg')]">
      ...
      <section className="my-12 lg:px-0 px-4">
